...
const api = Object.freeze({
    ...
    getSecondaryProducts: () => invoke("get-secondary-products"),
    saveSecondaryProduct: (product) => invoke("save-secondary-product", product),
    deleteSecondaryProduct: (id) => invoke("delete-secondary-product", id),
